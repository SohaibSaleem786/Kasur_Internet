...
const Get_Capacity = () => {
  ...
  const handleRowClick = (row) => {
    ...
    if (selectedRow === row.tcapcod) {
      ...
      navigate(`/Update_Capacity/${row.tcapcod}`);
    } else {
  ...
  return (
    <>
      ...
      <div className="col-12" style={{
        ...
        <br />
        <div className="Capacity-table"  style={{
                      ...
                      {Object.keys(row).map((key, columnIndex) => {
                        return (
                          <td
                            ...
                            style={{
                              backgroundColor:
                                color === row.tcapcod ? "#444ebd" : "",
                              color:
                                color === row.tcapcod ? secondaryColor : "",
                              fontWeight: color === row.tcapcod ? "bold" : "",
