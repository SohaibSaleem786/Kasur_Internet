...
export default function MonthlyRecovryReportPeriodWise() {
  ...
  const [gettheperiodstatus1, settheperiodstatus1] = useState("");
  ...
  const [perioddata1, setPerioddata1] = useState([]);
  const [selectedPeriodId1, setSelectedPeriodId1] = useState("");
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await fetch(
        ...
        const apiData = await response.json();
        setPerioddata1(apiData);
        if (apiData.length > 0) {
          setSelectedPeriodId1(apiData[0].id);
        }
      } catch (error) {
        console.error(error);
      }
  ...
  function fetchMobileLedger() {
    const apiUrl =
      "https://crystalsolutions.com.pk/kasurinternet/web/admin/PendingRecovery.php";
    setIsLoading(true);

    const formData = new URLSearchParams({
      strPeriod: gettheperiodstatus,
      endPeriod: gettheperiodstatus1,
    }).toString();
  ...
  const exportPDFHandler = () => {
    ...
    const columnWidths = [13, 13, 35, 13, 13, 13];
    ...
    const handlePagination = () => {
      ...
      while (currentPageIndex * rowsPerPage < rows.length) {
        ...
        // addTitle(
        //   `Mobile Ledger From: ${formattedFromDate} To: ${formattedToDate}`,
        //   "",
        //   "",
        //   pageNumber,
        //   startY,
    ...
    // Save the PDF file
    doc.save("MonthlyRecoveryReportPeriod.pdf");
  ...
  const handleDownloadCSV = async () => {
    ...
    // Set column widths
    [10, 10, 50, 15].forEach((width, index) => {
    ...
    const printContent = `
      <div style="padding: 20px; font-family: Arial, sans-serif;">
        <div style="text-align: center; border-bottom: 2px solid black; margin-bottom: 20px;">
          ...
          <h2 style="margin: 0; font-size: 18px;">MONTHLY RECOVERY REPORT PERIOD WISE</h2>
        </div>
        ...
        <div style="margin-bottom: 20px;">
          <div style="display: flex; justify-content: space-between; margin-bottom: 10px;">
            <div>
              <strong>From Period:</strong> ${gettheperiodstatus || "N/A"}
            </div>
                 <div>
              <strong>To Period:</strong> ${gettheperiodstatus1 || "N/A"}
            </div>
          </div>
        </div>
          ...
          <table style="width: 100%; border-collapse: collapse; font-size: 12px;">
            <thead style="background-color: #f0f0f0; font-weight: bold;">
              <tr>
                ...
                <th style="border: 1px solid black; padding: 5px;">MB</th>
        ...
        <div style="margin-top: 20px; display: flex; justify-content: space-between;">
          <div><strong>Total Pay:</strong> ${totalAmt || 0}</div>
        </div>
      </div>
    `;
  ...
  return (
    <>
      ...
      <Container
        ...
        id="ContainerStylingMobileLedger"
        style={{ width: "60vw" }}
      >
        <div style={{ margin: "0 -12px" }}>
          ...
          >
            ...
            <div style={{ fontSize: "14px" }} className="col-4 text-center">
              <strong>Monthly Recovery Report Period</strong>
            </div>
          ...
          <div className="mx-2">
            <div className="d-flex justify-content-between my-1 col-12">
              <div className="d-flex col-6 justify-content-start align-items-center">
                <label className="col-6 text-end">
                  <strong>From Period: &ensp;&ensp;</strong>
                </label>
                <Form.Group
                  controlId="status"
                  style={{
              ...
              <div className="d-flex col-6 justify-content-start align-items-center">
                <label className="col-6 text-end">
                  <strong>To Period: &ensp;&ensp;</strong>
                </label>
                <Form.Group
                  controlId="status"
                  style={{
                ...
                >
                  <Form.Control
                    ...
                    name="custareid"
                    onChange={(e) => {
                      settheperiodstatus1(e.target.value);
                    }}
                    id="companyid"
                    style={{
                      width: "100px",
          ...
          <div>
            ...
            <div
              className="col-12 border-dark border-top d-flex justify-content-between"
              style={{
            ...
            >
              <input
                type="text"
                value={getlength1}
                className="text-start border-dark"
                disabled
                style={{
                  ...firstColWidth,
                  height: "24px",
