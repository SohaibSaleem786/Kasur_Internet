    ...
    const fetchData = async () => {
      try {
        const response = await fetch(
          "https://crystalsolutions.com.pk/kasurinternet/web/admin/CRVNumber.php"
        );
        if (!response.ok) {
  ...
  const handleFormSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        `https://crystalsolutions.com.pk/kasurinternet/web/admin/CashReceiveVoucher.php`,
            ...
            <div className="col-md-12 form-CashReciptVoucher-container">
              ...
              >
                ...
                <div style={{ fontSize: "14px" }} className="col-4 text-center">
                  <strong>Cash Receive Voucher</strong>
                </div>
