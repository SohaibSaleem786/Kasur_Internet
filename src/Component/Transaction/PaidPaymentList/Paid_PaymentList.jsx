...
export default function Paid_PaymentList() {
  ...
  const exportPDFHandler = () => {
    ...
    const handlePagination = () => {
      ...
      while (currentPageIndex * rowsPerPage < rows.length) {
        ...
        addTitle(`Paid Payment`, "", "", pageNumber, startY, 14); // Render sale report title with decreased font size, provide the time, and page number
        startY += 13;
        ...
        <div style={{ margin: "0 -12px" }}>
          ...
          >
            ...
            <div style={{ fontSize: "14px" }} className="col-4 text-center">
              <strong>MONTHLY PAYMENT STATUS</strong>
            </div>
