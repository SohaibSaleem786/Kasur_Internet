...
const Status_Tracking = () => {
  ...
  function UserLogin(perioddd) {
    ...
    axios
      .post(`${apiLinks}/PendingPaymentList.php`, formData, {
        headers: {
          "Content-Type": "application/x-www-form-urlencoded",
        },
      })
  ...
  const handleRowClick = (row) => {
    ...
    setColor(row.cust_id);
    if (selectedRow === row.cust_id) {
    } else {
      setSelectedRow(row.cust_id);
    }
  };
...
`;
  ...
  function CustomerDetail(dataa) {
    ...
    axios
      .post(`${apiLinks}/customer/CustomerCollectionDetail.php`, formData, {
        headers: {
          "Content-Type": "application/x-www-form-urlencoded",
        },
      })
  ...
  return (
    <>
      ...
      >
        <br />
        <div
          className="StatusTracking-table"
          style={{
        ...
        >
          ...
          >
            ...
            <div style={{ fontSize: "14px" }} className="col-4 text-center">
              <strong>Pending Payment List</strong>
            </div>
...
export default Status_Tracking;
