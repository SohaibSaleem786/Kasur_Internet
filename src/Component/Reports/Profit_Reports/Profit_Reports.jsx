...
import "./Profit_Reports.css";
import Footer from "../../MainComponent/Footer/Footer";
import Header from "../../MainComponent/Header/Header";

export default function Profit_Reports() {
  ...
  const fetchDailyDocumentEditItems = () => {
    const apiUrl =
      "https://crystalsolutions.com.pk/kasurinternet/web/admin/ProfitReport.php";
    setIsLoading(true);
  ...
  const exportPDFHandler = () => {
    ...
    const headers = ["Payment", "Fee", "Receive", "Period", "Profit"];
    const columnWidths = [20, 20, 20, 30, 30];
    ...
    const handlePagination = () => {
      ...
      while (currentPageIndex * rowsPerPage < rows.length) {
        ...
        addTitle(`PROFIT REPORT`, "", "", pageNumber, startY, 14);
        startY += 13;
  ...
  const exportCSVHandler = async () => {
    ...
    [
      ...
      `PROFIT REPORT From ${formattedFromDate} To ${formattedToDate}`,
    ].forEach((title, index) => {
  ...
  return (
    <>
      ...
      <Container
        ...
        id="ContainerStylingProfitReport"
      >
        <div style={{ margin: "0 -12px" }}>
          ...
          >
            ...
            <div style={{ fontSize: "14px" }} className="col-4 text-center">
              <strong style={{ color: "white" }}>Profit Reports</strong>
            </div>
                ...
                >
                  ...
                  >
                    <td className="border-dark" style={firstColWidth}>
                      <a style={{ color: "white" }}>Payment Voucher</a>
                    </td>
                    <td className="border-dark" style={secondColWidth}>
                      <a style={{ color: "white" }}>Fee Voucher</a>
                    </td>
                    <td className="border-dark" style={thirdColWidth}>
                      <a style={{ color: "white" }}>Receive Voucher</a>
                    </td>
                    <td className="border-dark" style={forthColWidth}>
                      <a style={{ color: "white" }}>Period</a>
                    </td>
                    <td className="border-dark" style={fifthColWidth}>
                      <a style={{ color: "white" }}>Profit</a>
                    </td>
                  </tr>
                </thead>
              </table>
