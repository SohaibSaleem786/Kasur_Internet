import "./Recovery_Pending_Report.css";
...
export default function Recovery_Pending_Report() {
  ...
  const exportPDFHandler = () => {
    ...
    const headers = ["Account", "Mobile", "Customer", "Amount"];
    const columnWidths = [20, 20, 60, 30];
    ...
    const handlePagination = () => {
      ...
      while (currentPageIndex * rowsPerPage < rows.length) {
        ...
        addTitle(`Recovery Pending Report`, "", "", pageNumber, startY, 14); // Render sale report title with decreased font size, provide the time, and page number
        startY += 13;
    ...
    // Save the PDF file
    doc.save("RecoveryPendingReport.pdf");
  ...
  const handleDownloadCSV = async () => {
    ...
    saveAs(blob, "RecoveryPendingReport.xlsx");
  };
  ...
  return (
    <>
      ...
      <Container
        ...
        id="ContainerStylingRecoveryPendingReportLedger"
      >
        <div style={{ margin: "0 -12px" }}>
          ...
          >
            ...
            <div style={{ fontSize: "14px" }} className="col-4 text-center">
              <strong>RECOVERY PENDING REPORT</strong>
            </div>
